...
글의 첫 문단은 독자가 겪고 있을 상황이나 고민으로 시작하세요. "어깨 통증이 계속되고 팔을 들어올리기도 힘들다면"처럼 독자가 "이거 내 얘기네"라고 느낄 수 있는 도입이 좋습니다.
...
소제목은 ###으로 표시하고, 독자의 흥미를 끌 수 있는 다양한 방식으로 작성하세요. 질문형, 핵심 메시지 요약, 독자 공감 유도 등 글의 흐름에 맞는 형태를 선택합니다.
